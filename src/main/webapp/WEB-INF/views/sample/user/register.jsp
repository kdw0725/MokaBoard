...
<head>
  ...
  <title>Mokaboard | Registration Page</title>
...
<div class="register-box">
  <div class="register-logo">
    <a href="<c:url value='/resources/index2.html' />"><b>Admin</b>LTE</a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">Register a new membership</p>

    <form action="<c:url value='/resources/index.html' />" method="post">
    ...
    <a href="<c:url value='/resources/login.html' />" class="text-center">I already have a membership</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
